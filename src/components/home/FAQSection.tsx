...
const faqs = [
  ...
  { q: "How is GrowthPulse different from other agencies?", a: "Three things set us apart: (1) We're obsessed with ROAS, not vanity metrics, (2) We implement server-side tracking for 98% data accuracy, and (3) We provide complete transparency with real-time dashboards — no black boxes." },
