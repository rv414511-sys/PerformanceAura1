      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <motion.div initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 0.2 }} className="hidden lg:block">
          <div className="relative">
            ...
            <img src={heroTeam} alt="Digital marketing team analyzing growth data" className="relative rounded-2xl shadow-2xl w-full h-auto object-cover border border-primary-foreground/10" />
