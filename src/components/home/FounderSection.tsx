        ...
        >
          <div className="relative">
            ...
            <img
              ...
              className="relative w-72 h-72 object-cover object-top rounded-2xl shadow-xl border border-border"
            />
            <div className="absolute -bottom-3 -right-3 bg-primary text-primary-foreground rounded-xl px-4 py-2 text-sm font-semibold shadow-lg">
              Founder & CEO
            </div>
          </div>
        </motion.div>
