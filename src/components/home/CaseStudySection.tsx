...
const caseStudies = [
  {
    ...
    results: [
      { metric: "ROAS", before: "1.4x", after: "3.2x" },
      { metric: "CAC", before: "₹1,200", after: "₹650" },
      { metric: "Monthly Revenue", before: "₹5L", after: "₹18L" },
    ],
    timeline: "6 months",
  },
  {
    ...
    challenge: "Google Ads generating leads but only 5% were sales-qualified, wasting the sales team's time.",
    solution: "Implemented intent-based keyword strategy, added lead scoring via form qualification, and built a nurture funnel.",
    results: [
      { metric: "SQL Rate", before: "5%", after: "18%" },
      { metric: "Cost per SQL", before: "₹6,500", after: "₹3,200" },
      { metric: "Pipeline Value", before: "₹5L/mo", after: "₹15L/mo" },
    ],
    timeline: "4 months",
  },
  {
    ...
    challenge: "Stuck at ₹4L/month revenue with rising ad costs and no systematic scaling framework.",
    solution: "Built a full-funnel Meta + Google strategy, introduced UGC-led creatives, and implemented a subscription model.",
    results: [
      { metric: "Monthly Revenue", before: "₹4L", after: "₹14L" },
      { metric: "Repeat Purchase", before: "10%", after: "28%" },
      { metric: "Ad Spend Efficiency", before: "1.8x", after: "3.4x" },
    ],
    timeline: "5 months",
  },
];
