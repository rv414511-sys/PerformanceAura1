    ...
    <>
      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <img src={heroBg} alt="Premium marketing background" className="w-full h-full object-cover" />
        ...
        <div className="relative container mx-auto px-6 py-20">
          ...
          >
            ...
            <h1 className="font-display text-4xl md:text-5xl lg:text-7xl font-bold text-primary-foreground leading-tight">
              Grow Your Brand
              <br />
